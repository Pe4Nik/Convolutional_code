...
public class Trellis {
	...
	public TreeMap<StateAndInfoBit,StateWithInflow> myTrellis;
	...
	private class TrellisFrame extends JPanel{
		...
		protected void paintComponent(Graphics g){
			...
			for(int i = 0;i < (1 << totStatesLog ); i++){
				...
				if(i == 0) {
					g2.drawString("00",firstCircleVertex + radius/2 ,(int)(firstCircleVertex + radius* 4/3  + i*circleVertexDistance));
					g2.drawString("00",w-firstCircleVertex-circleDiameter + radius/2 ,(int)(firstCircleVertex + radius* 4/3  + i*circleVertexDistance));
				}
				if(i == 1) {
					g2.drawString("01",firstCircleVertex + radius/2 ,(int)(firstCircleVertex + radius* 4/3  + i*circleVertexDistance));
					g2.drawString("01",w-firstCircleVertex-circleDiameter + radius/2 ,(int)(firstCircleVertex + radius* 4/3  + i*circleVertexDistance));
				}
				else {
